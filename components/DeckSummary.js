...
const DeckSummary = ({route, navigation}) => {
  const {name, cardIds} = route.params
  return (
    <View style = {styles.container}>
      <Text style = {styles.header}>{name}</Text>
      <Text style = {styles.subheader}>{cardIds.length} Cards</Text>
      <View style = {styles.buttonsWrapper}>
        ...
        <TouchableOpacity onPress = {() => navigation.navigate('Create Flashcard', { name })} style = {[styles.border, styles.button, styles.secondary]}>
